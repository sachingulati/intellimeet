    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><span class='glyphicon glyphicon-th-list'></span></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><span class='glyphicon glyphicon-indent-right'></span></a>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><span class='glyphicon glyphicon-indent-left'></span></a>" +
                "</div>" +
                "</li>";
        },
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ...
                "</div>" +
                "</div>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><span class='glyphicon glyphicon-share'></span></a>" +
                "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "</div>" +
                "</div>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><span class='glyphicon glyphicon-picture'></span></a>" +
                "</li>";
        },
