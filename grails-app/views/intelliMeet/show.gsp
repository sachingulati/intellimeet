...
<html>
	...
	<body>
    <a href="#show-intelliMeet" class="sr-only" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <div id="show-intelliMeet" class="container" role="main">
        ...
        <g:form class="form-horizontal" url="[resource:intelliMeetInstance, action:'delete']" method="DELETE">
            <g:render template="staticForm"/>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <g:link class="btn btn-lg btn-default" action="edit" resource="${intelliMeetInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
